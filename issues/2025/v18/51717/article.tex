...
\othertitle{Metodologias educacionais e tradução audiovisual didática: Resultados de uma implementação de revogação e legendagem combinadas em uma classe de ensino fundamental com o método Montessori}
...
\input{sec-theoreticalframework.tex}
