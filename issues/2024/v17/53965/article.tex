...
\section{Introdução}
O objetivo central deste artigo é mapear artigos internacionais que investigam o uso de dados abertos como recursos didáticos nos ensinos superior e básico, oferecendo uma compreensão abrangente do tema. Para isso, o estudo se apoia em pesquisas que exploram dados abertos aplicados a práticas de ensino e aprendizagem \cite{atenas2015,lobo2015,buzato2006,buzato2018,coughlan2019,kukulska-hulme2020}.
...
Destacamos a seguir os principais resultados das publicações sobre o uso educacional de dados abertos, abrangendo dados relacionadas à publicação de artigos nos ensinos superior e básico, à área de conhecimento dos autores e ao volume de publicações por continentes (ver \Cref{fig7}).
