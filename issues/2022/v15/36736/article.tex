...
\theyear{2022}
\receiveddate{\DTMdisplaydate{2021}{10}{12}{-1}} % YYYY MM DD
...
\keywords{Reconhecimento automático da fala \sep Texto-fala \sep CALL \sep Ensino de pronúncia \sep Aprimoramento de pronúncia}
\end{abstract}
\end{portuguese}
