...
\begin{filecontents*}[overwrite]{article.xmpdata}
    ...
    \Author{Ana Yamile Pérez Puentes \sep Juan Guillermo Diaz Bernal}
    \Language{es}
...
\publisheddate{\DTMdisplaydate{2021}{4}{29}{-1}}
% Corresponding author
\corrauthor{Ana Yamile Pérez Puentes}
% DOI
\articledoi{10.35699/1983-3652.2021.29523}
% list of available sesscions in the journal: articles, dossier, reports, essays, reviews, interviews, editorial
\articlesessionname{Producción de Textos y Tecnología}
...
\affil[1]{Secretaria de Educación de Boyacá, Boyaca, Colombia.}
\affil[2]{Universidad Pedagógica y Tecnológica de Colombia, Boyaca, Colombia.}
