...
\othertitle{EXPLORING MATHEMATICS AND PHYSICAL WITH LINE FOLLOWER ROBOT FROM THE PERSPECTIVE OF FREE ROBOTICS}
...
podem ser retirados/reutilizados estão listados no \Cref{tab01}.
...
equivalentes que constam ou não no \Cref{tab01}. As medidas também podem ser
...
\item O primeiro item a ser confeccionado é o chassi, suporte para os componentes.
    \begin{enumerate}
    \item Em um ACM desenhe a \Cref{fig01}, onde triângulo de referência é isósceles, cujo centro de massa foi encontrado.
    \item Recorte o chassi.

    \begin{figure}[h!]
    \begin{minipage}{0.47\textwidth}
    \includegraphics[width=\linewidth]{figure-01.png}
    \subcaption{}
    \end{minipage}
    \hfill
    \begin{minipage}{0.47\textwidth}
    \includegraphics[width=\linewidth]{figure-02.png}
    \subcaption{}
    \end{minipage}
    \caption{Chassi.}
    \label{fig01}
    ...
    \begin{enumerate}
    \item Com uma lâmina para arco de serra, retire os componentes como indicado na \Cref{fig02}.

    \begin{figure}[h!]
    \begin{minipage}{0.47\textwidth}
    \includegraphics[width=\linewidth]{figure-03.png}
    \subcaption{}
    \end{minipage}
    \hfill
    \begin{minipage}{0.47\textwidth} 
    \includegraphics[width=\linewidth]{figure-04.png}
    \subcaption{}
    \end{minipage}
    ...
    \item Desenhe dois círculos de raio 2,5cm em um chinelo. Recorte-os para
    ...
    \includegraphics[width=\linewidth]{figure-05.png}
    \subcaption{}
    \end{minipage}
    \hfill
    \begin{minipage}{0.31\textwidth} 
    \includegraphics[width=\linewidth]{figure-06.png}
    \subcaption{}
    \end{minipage}
    \hfill
    \begin{minipage}{0.31\textwidth} 
    \includegraphics[width=\linewidth]{figure-07.png}
    \subcaption{}
    \end{minipage}
    ...
    \item Fixe as duas estruturas de motor/polias/engrenagens/rodas no chassi
    ...
    \begin{figure}[h!]
    \begin{minipage}{0.47\textwidth}
    \includegraphics[width=\linewidth]{figure-08.png}
    \subcaption{}
    \end{minipage}
    \hfill
    \begin{minipage}{0.47\textwidth} 
    \includegraphics[width=\linewidth]{figure-09.png}
    \subcaption{}
    \end{minipage}
...
evitando velocidades muito altas e imprecisão do AGV. Se a tensão no motor for
menor ou igual a 2,8V ele permanece em repouso, se for maior entrará em
movimento. A velocidade de rotação do motor depende da tensão nele.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{figure-12.png}
\caption{Resistores.}
\label{fig06}
\source{Acervo dos autores.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{figure-13.png}
...
resistor, que será calculado na \Cref{sec-escolha-resistor}, deve ser $300\Omega$, o qual pode ser
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{figure-14.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{figure-15.png}
\caption{LDR.}
\label{fig09}
\source{Acervo dos autores.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.25\textwidth]{figure-17.png}
\caption{Transistor.}
\label{fig11}
\source{Acervo dos autores.}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\textwidth]{figure-18.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{figure-19.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{figure-20.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{figure-21.png}
...
processo, foram encontrados os componentes citados na quarta coluna do \Cref{tab01}.
...
entendimento, bem como a elaboração da SD. Foi elaborado um esquema, Figura 16,
para montagem das partes do circuito. No segundo circuito foram testados tanto
potenciômetros quanto transistores para estabelecer uma resistência elétrica.
...
elencados no \Cref{tab02}, a fim de facilitar a procura do componente em sucatas.
...
\item Utilize para demonstração as polias e engrenagens ilustradas na \Cref{fig17}.
    ...
    \includegraphics[width=\linewidth]{figure-24.png}
    \subcaption{Motor/$P_1$.}\label{fig17a}
    \end{minipage}
    \hfill
    \begin{minipage}{0.2\textwidth} 
    \includegraphics[width=\linewidth]{figure-25.png}
    \subcaption{$P_2/E_2$.}\label{fig17b}
    \end{minipage}
    \hfill
    \begin{minipage}{0.2\textwidth} 
    \includegraphics[width=\linewidth]{figure-26.png}
    \subcaption{$E_1$ e engrenagem onde será conectada a roda.}\label{fig17c}
    \end{minipage}
    \hfill
    \begin{minipage}{0.33\textwidth} 
    \includegraphics[width=\linewidth]{figure-27.png}
    ...
    \begin{enumerate}
    \item Calcule o raio de $P_1$ (0,27cm) e seu comprimento ($\approx$ 1,69cm).
    \item Calcule o raio de $P_2$ (0,9cm) e seu comprimento ($\approx$ 5,65cm).
    \item Relembre/introduza o que são grandezas diretamente proporcionais
    utilizando como exemplo o raio e o comprimento da circunferência.
    \item Induza os estudantes a perceberem que uma volta completa da $P_2$
    ...
    \begin{align}
    f_1: \mathcal{R}^{+} \rightarrow \mathcal{R}^{+} && f_{1}^{-1}: \mathcal{R}^{+} \rightarrow \mathcal{R}^{+} \\
    x \rightarrow 0,299x && x \rightarrow 3,342x \nonumber
    \end{align}
...
\item Enfatize que o giro de E2 movimenta uma engrenagem de 60 dentes
...
com relação ao número de voltas da $E_1$.
    ...
    \begin{align}
    f_2: \mathcal{R}^{+} &\rightarrow \mathcal{R}^{+} & f_{2}^{-1}: \mathcal{R}^{+} &\rightarrow \mathcal{R}^{+} \\
...
\item\label{itm1sec423} Faça um apanhado sobre composição de funções e introduza a função $f_2 \circ f_1$
    \begin{align}
    f_2 \circ f_1: \mathcal{R}^{+} &\rightarrow \mathcal{R}^{+}  \\
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{figure-28.png}
...
RPM a roda fará $\left( \frac{3000}{15,7} \approx 191 \textmd{RPM}\right)$.
Enfatize que esse foi o número de RPM da roda no teste.
\item Retome o item 3) da seção 4.2.3 (245 RPM da roda). Ressalte a grande
...
desafio deverão utilizar a função inversa de $f_1 \circ f_2$ (aplicada a 191
...
\item Realizando o mesmo estudo para $P_1$ e $P_2$, onde cada volta da  corresponde a $3,343$ voltas da $P_1$, conclua que houve um ganho de $14,32$ de torque na roda ($E_1$) em relação ao torque do motor ($P_1$), conseguindo gerar força para deslocar o AGV no percurso.
\begin{equation}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.5\textwidth]{figure-29.png}
\caption{Circuito associado em série.}
\label{fig19}
\source{Acervo dos autores.}
\end{figure}

\item Discuta a 2a Lei de Kirchhoff (Lei das Malhas e suas consequências),
...
componentes no circuito que continuarão valendo as conclusões.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{figure-30.png}
\caption{Circuito associado em paralelo.}
\label{fig20}
\source{Acervo dos autores.}
\end{figure}

\item Discuta a 1a Lei de Kirchhoff (Lei dos Nós), segundo a qual, em qualquer
...
\begin{equation}
\frac{V}{R} = I = \sum_{i=1}^{4} I_i = \sum_{i=1}^{4} \frac{V_i}{R_i} = \frac{i=1}{4} \frac{V}{R_i} = V \sum_{i=1}^{4} \frac{1}{R_i} \Rightarrow \frac{1}{R} = \sum_{i=1}^{4} \frac{1}{R_i} .
\end{equation}
\item Generalize a fórmula para o caso $n$.
\end{enumerate}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.3\textwidth]{figure-31.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.2\textwidth]{figure-32.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth]{figure-33.png}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.3\textwidth]{figure-34.png}
...
\item Substituindo os valores na fórmula, obtenha a tensão no potenciômetro em função da resistência do LDR $\left( V_{pot} = \frac{220}{R_{LDR} + 220} 9 \right)$.
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth]{figure-35.png}
...
de 1cm do chão e distante 1cm do LDR e $V_{FA}=9V$, serão obtidos os valores do \Cref{tab04}:
...
\begin{figure}[h!]
\begin{minipage}{0.47\textwidth}
\includegraphics[width=\linewidth]{figure-36.png}
\subcaption{}
\end{minipage}
\hfill
\begin{minipage}{0.47\textwidth}
\includegraphics[width=\linewidth]{figure-37.png}
\subcaption{}
\end{minipage}
...
\begin{align}
h: \mathcal{R}^{+} &\rightarrow \mathcal{R}^{+} \\
...
perdas ocorridas no percurso, obtém-se, aproximadamente, 192RPM para a roda. O
