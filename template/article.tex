...
\begin{funding}
Esta pesquisa foi financiada pela Fundação Nacional de Ciências (FNC), que forneceu suporte financeiro essencial para investigar o impacto das tecnologias de energia renovável na sustentabilidade urbana. O financiamento facilitou a coleta e análise abrangente de dados, bem como a colaboração com especialistas na área, permitindo-nos contribuir com insights valiosos para o atual debate sobre conservação ambiental e eficiência energética.
\end{funding}
