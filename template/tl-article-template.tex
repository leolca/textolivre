...
\section{Contribuição dos autores}\label{sec-contributors}
...
CRediT (\emph{Contributor Roles Taxonomy}), utilizadas para representar as contribuições do autores:
Conceituação;
Curadoria de dados;
Análise Formal;
...
\begin{contributors}\label{sec-contributors}
\item \textbf{Conceituação}: Leonardo Araújo
\item \textbf{Curadoria de dados}: N/A
\item \textbf{Análise Formal}: N/A
\item \textbf{Aquisição de financiamento}: Daniervelin Pereira
\item \textbf{Investigação}: N/A
\item \textbf{Metodologia}: Daniervelin Pereira, Leonardo Araújo
\item \textbf{Administração de projetos}: Daniervelin Pereira
\item \textbf{Recursos}: Daniervelin Pereira
\item \textbf{Programas}: Leonardo Araújo
\item \textbf{Supervisão}: Daniervelin Pereira
\item \textbf{Validação}: N/A
\item \textbf{Visualização}: Leonardo Araújo
\item \textbf{Escrita - rascunho original}: Leonardo Araújo, Daniervelin Pereira
\item \textbf{Escrita - revisão e edição}: Leonardo Araújo, Daniervelin Pereira.
\end{contributors}
