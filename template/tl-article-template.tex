...
uma lista aninhada, ou talvez dividir a tabela em duas. 
Quando optar por utilizar uma tabela, busque deixá-la visualmente leve. Lembre-se que os dados são os elementos
importantes em uma tabela. Evite utilizar linhas verticais. Busque utilizar apenas as linhas horizontais 
...
Se desejar referenciar o nome completo do primeiro autor, podemos utilizar o seguinte comando disponível no template da revista: \verb|\citefirstlastauthor{...}|.
No exemplo a seguir, utilizamos uma epígrafe, seguindo o modelo do template (veja o código fonte deste documento), 
