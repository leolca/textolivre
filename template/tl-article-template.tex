...
Este artigo é o modelo de documento que visa orientar os autores que submeterão seus textos à revista Texto Livre.
...
A \Cref{sec-organizacao} apresenta as normas para a submissão, considerações gerais sobre a organização do artigo, apresenta a utilização 
de listas numeradas e não-numeradas, ilustra como inserir figuras e tabelas no documento, assim como citações 
e notas de rodapé. A \Cref{sec-equacao} apresenta exemplos de equações. 
...
Caso haja necessidade de incluir novos pacotes e criar novas definições específicas para um artigos, 
