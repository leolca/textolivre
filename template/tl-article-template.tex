...
\author[1]{Leonardo Araújo \orcid{0000-0000-0000-0000} \thanks{Email: \url{leolca@ufsj.edu.br}}}
\author[2]{Daniervelin Pereira \orcid{0000-0000-0000-0000} \thanks{Email: \url{revista@textolivre.org}}}
\author[3]{Ana Cristina Fricke Matte}
...
\subsection{Modelo \LaTeX{}}\label{sec-organizacao-latex}
...
Os autores do manuscrito são definidos são definidos utilizando os comandos do pacote \verb|authblk|.
...
\begin{lstlisting}[language=tex, label=lst-authors, caption={Definição dos autores do manuscrito.}]
...
Para definir como o nome dos autores aparecerá no rodapé do artigo, utilize o comando \verb|\runningauthor{...}|.
...
Não faça referência às figuras dizendo `a figura abaixo/acima' pois, com a diagramação do texto, a figura poderá não ficar exatamente logo abaixo/acima do texto que a referencia.
...
\begin{lstlisting}[language=tex, label=lst-figure, caption={Inserindo uma figura.}, float]
\begin{figure}[htbp]
 \centering
 \includegraphics[width=0.5\textwidth]{example-image-a}
 \caption{Imagem de teste.}
