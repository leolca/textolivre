...
% $ make4ht -c textolivre-html.cfg -u -x article "fn-in"
% $ bibtex article
...
\begin{filecontents*}{article.xmpdata}
    ...
    \Author{Leonardo Araújo \sep Daniervelin Pereira \sep Ana Cristina Fricke Matte}
    \Language{pt-BR}
...
\author[2]{Ana Cristina Fricke Matte}
...
\setbibligraphyfile{tl-article-template.bib} % has different behaviour compiling PDF and HTML
...
\tlprintbibliography\label{sec-bib} % print bibliography has different behaviour for PDF and HTML
